...
version_num=4
future_avg = "future_3yr_awarded_avg"
future_avg_name = "3-year avg"
set.seed(5)
...
matchobj_gbm_1 <-matchit(as.formula(paste("int.funding.awarded ~", paste(indvars, collapse="+"))) , data= matchset , method="optimal",distance =  "gbm")
